...
if(isset($_GET['type']) && $_GET['type'] != ''){
   ...
   if($type == 'status'){
      ...
      $update_status_sql = "UPDATE product SET status='%s' WHERE id='%s'";
      $update_status_sql = sprintf($update_status_sql, $status, $id);
   ...
   if($type == 'delete'){
      ...
      $delete_status_sql = "DELETE FROM product WHERE id='%s'";
      $delete_status_sql = sprintf($delete_status_sql, $id);
