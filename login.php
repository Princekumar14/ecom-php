...
?>
        ...
        <div class="ht__bradcaump__area" style="background: rgba(0, 0, 0, 0) url(images/bg/product-detail_BG.jpg) no-repeat scroll center center / cover ;">
						...
						<div class="contact-form-wrap mt--60">
							...
							<div class="col-xs-12">
								<form id="contact-form" method="post">
									...
									<div class="single-contact-form">
										<div class="contact-box name">
											<input type="mobile" name="mobile" id="mobile" placeholder="Your Mobile*" style="width:100%">
										</div>
